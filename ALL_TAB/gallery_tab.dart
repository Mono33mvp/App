...
class _ImageListScreenState extends State<ImageListScreen> {
  ...
  //   final ListResult result=await storageRef.listAll();
    ...
    ListResult result = await storageref.child('indoorGallery').listAll();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Indoor Photos',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 22,color: Colors.white),),
      ),
      body:
      GridView.builder(
