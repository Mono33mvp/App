...
import 'package:untitled/common/toast.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:google_sign_in/google_sign_in.dart';

import 'package:untitled/firebase_auth/firebase_auth_service.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //       child: const Text("HSMS",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 40,color: Colors.blueAccent),)),
       ),
      body: Center(
        child: Padding(
